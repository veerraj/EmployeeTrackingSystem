...
var version = typeof "7.3.10" !== 'undefined' ? "7.3.10" : _globals.global.DECK_VERSION || 'untranspiled source';
var STARTUP_MESSAGE = 'set deck.log.priority=1 (or higher) to trace attribute updates';
var existingVersion = _globals.global.deck && _globals.global.deck.VERSION;
...
if (!existingVersion) {
  ...
  _globals.global.deck = Object.assign(_globals.global.deck || {}, {
    VERSION: version,
    version: version,
    log: _log["default"]
  });
